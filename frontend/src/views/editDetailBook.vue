      ...
      <div class="columns">
        <div class="column is-2">
          ...
          <div class="ubox box" style="width: 800px">
            <div class="">
            <div class="k-title title">แก้ไขข้อมูลหนังสือ</div>
            <div class="k-fe field">
                <label class="label">ชื่อหนังสือ</label>
                <p class="control has-icons-left">
                    <span> ชื่อเดิม : {{book.title}}</span>
            ...
            <div class="k-fe field">
                ...
                <p class="control has-icons-left">
                    <span> ชื่อผู้แต่งเดิม : {{book.alias}}</span>
            ...
            <div class="k-fe field">
                ...
                <p class="control has-icons-left">
                    <span> ลิงก์รปกหน้าเดิม : {{book.image_url1}}</span>
            ...
            <div class="k-fe field">
                ...
                <p class="control has-icons-left">
                    <span> ลิงก์ปกหลังเดิม : {{book.image_url2}}</span>
            ...
            <div class="k-fe field">
                ...
                <p class="control has-icons-left has-icons-right">
                    <span> ประเภทหนังสือเดิม : {{book.name}}</span>
            ...
            <div class="k-fe field">
                ...
                <p class="control has-icons-left">
                    <span> จำนวนสินค้าเดิม : {{book.unit}}</span>
            ...
            <div class="k-fe field">
                ...
                <p class="control has-icons-left">
                    <span> ราคาสินค้าเดิม : {{book.price}}</span>
            ...
            <div class="k-fe field">
                ...
                <span> สำนักพิมพ์เดิม : {{book.pub_name}}</span>
                <p class="control has-icons-left">
            ...
            <div class="k-fe field">
                ...
                <p class="control has-icons-left">
                    <span> บาร์โค้ดเดิม : {{book.barcode}}</span>
            ...
            <div class="k-fe field">
                ...
                <p class="control has-icons-left">
                    <span> ISBN เดิม : {{book.isbn_num}}</span>
            ...
            <div class="k-fe field">
                ...
                <p class="control has-icons-left">
                    <span> เนื้อเรื่องย่อเดิม : {{book.description}}</span>
...
export default {
  ...
  methods: {
    ...
    submitFile() {
        ...
        const bookId = this.$route.params.bookId;
        axios
        .post(`http://localhost:3000/book/updateBook/${bookId}`, data)
        .then((response) => {
          alert(response.data)
        });
        this.bookname = '',
